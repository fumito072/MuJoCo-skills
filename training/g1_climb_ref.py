...
KEY_FRAMES = [
    ...
    # the trail-foot TRANSITION (foot leaves floor -> lands on platform) was the WALL:
    # the policy tracked the whole climb but got stuck one-foot / z0.87. Slow ONLY
    # that dynamic transition (~0.4s -> ~1.4s), with a BRIEF (not long) lunge settle
    # — a long one-foot static hold would just collapse from lack of holding torque.
    (4.0, {},                                                0.49, 0.875),  # brief lunge settle (0.4s)
    (5.4, {6: -0.31, 9: 0.63, 10: -0.30, 0: -1.10, 3: 1.90, 4: -0.40},
                                                             0.44, 0.940),  # L trail leg up (SLOW transition)
    (6.4, {0: -0.31, 3: 0.63, 4: -0.30},                     0.41, 0.975),  # L plant beside, stand
    (7.0, {},                                                0.40, 0.975),  # hold stand
]
